...
public class BoardController {
	...
	public String list(@RequestParam(value = "page", required = true, defaultValue = "0") int page,
	...
	public String searchList(@RequestParam(value = "page", required = true, defaultValue = "0") int page,
			@RequestParam(value = "kwd", required = true, defaultValue = "") String kwd, Model model) {
		Map<String, Object> map = boardService.list(page, kwd);
		model.addAllAttributes(map);
	...
	public String reply(@PathVariable("no") long no, UserVo authuser,
			@RequestParam(value = "page", required = true, defaultValue = "0") int page,
			@RequestParam(value = "kwd", required = true, defaultValue = "") String kwd, Model model) {
		BoardVo boardVo = new BoardVo();
		boardVo.setNo(no);
	...
	public String deleteComment(@ModelAttribute CommentVo commentVo,
			@RequestParam(value = "page", required = true, defaultValue = "0") int page,
			@RequestParam(value = "kwd", required = true, defaultValue = "") String kwd) {
